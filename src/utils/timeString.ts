export function msDurationToString(ms: number, abbreviate: boolean = false): string {
	const years: number = Math.round(Math.abs(ms) / (1000 * 60 * 60 * 24 * 365));
	const months: number = Math.round((Math.abs(ms) % (1000 * 60 * 60 * 24 * 365)) / (1000 * 60 * 60 * 24 * 30));
	const weeks: number = Math.round((Math.abs(ms) % (1000 * 60 * 60 * 24 * 30)) / (1000 * 60 * 60 * 24 * 7));
	const days: number = Math.round((Math.abs(ms) % (1000 * 60 * 60 * 24 * 7)) / (1000 * 60 * 60 * 24));
	const hours: number = Math.round((Math.abs(ms) % (1000 * 60 * 60 * 24)) / (1000 * 60 * 60));
	const minutes: number = Math.round((Math.abs(ms) % (1000 * 60 * 60)) / (1000 * 60));
