...
export default function AddNew({
    ...
    const [activeMenu, setActiveMenu] = useState<"task" | "event" | "tagBlock">(
        "task"
    );
                    ...
                    >
                        <div className="bg-off-white rounded-lg flex justify-between p-[10px] h-[83px] flex-shrink-0 m-[10px]">
                            <button
                                ...
                                className="bg-dark text-white font-semibold w-[200px] text-xl rounded-md"
                            >
                                Task
                            </button>
                            <button
                        ...
                        <div className="bg-gray-50 h-full max-h-full m-[10px] flex ">
                            <div className="h-full w-[82px] flex-shrink-0 mr-2">
                                <div
                                    className={`text-right flex items-center justify-end mb-[10px] ${
                                        activeMenu === "tagBlock"
                                            ? "h-[40px]"
                                            : "h-[30px]"
                                    }`}
                                ...
                                <div className="text-right flex items-center justify-end mb-[10px] h-[30px]">
                                    {activeMenu === "task"
                                        ? "Duration"
                                        : "Start Date"}
                                </div>
                                ...
                                <div className="text-right flex mb-[10px] h-[100px]">
                                    Description
                                </div>
                                {activeMenu !== "tagBlock" && (
                                    <div className="flex items-center justify-end text-right mb-[10px] h-[40px]">
                                        Tags{" "}
                                    </div>
                                )}
                            </div>
                            ...
                            <div className="h-full w-full">
                                {activeMenu !== "tagBlock" && (
                                    <div className="mb-[10px] h-[30px] rounded-xl bg-off-white flex">
                                        ...
                                        />
                                        <div className="text-right text-sm/6 flex items-center px-[10px]">
                                            Name
                                        </div>
                                    </div>
                                )}
                                {activeMenu === "tagBlock" && (
                                    <div className="text-right mb-[10px] h-[40px] flex">
                                        <div className="w-full text-right rounded-xl bg-off-white flex mr-[10px] px-[10px] truncate"></div>
                                        <button
                                            className=" justify-center items-center w-full max-w-[40px] text-right rounded-xl bg-off-white flex"
                                            aria-label="Add Tag Block"
                                        >
                                ...
                                {activeMenu === "task" && (
                                    <div className="text-right mb-[10px] h-[30px] flex ">
                                        <div className="w-full px-[10px] text-right rounded-xl bg-off-white flex truncate">
                                            ...
                                            />
                                            <div className="min-w-0 w-full max-w-max text-right text-sm/6 flex items-center">
                                                Days
                                            </div>
                                        </div>
